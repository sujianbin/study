        ...
        <div class="page-content">
            <div class="Role_Manager_style">
                <div class="Manager_style">
                    ...
                    <button type="button" class="btn btn-primary btn-redirect btn-current" name="{:url('@controller@/categoryModify')}">添加@name@类别</button>
                </div>
                <div class="Manager_style">
                    <div class="title_name">{$model['cat_id']|tag_show=['添加','编辑']}@name@类别</div>
                    <div class="Role_list">
                        <form name="myform" action="{:url('@controller@/categoryUpdate')}" method="post">
