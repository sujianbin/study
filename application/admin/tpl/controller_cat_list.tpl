                            ...
                            <tbody>
                                {volist name="lists" id="vo"}
                                    <tr>
                                        ...
                                        <td>  
                                            <button type="button" class="btn btn-primary btn-redirect" name="{:url('@controller@/modify',array('id'=>$vo['cat_id']))}">修改</button> 
                                            <button type="button" class="btn btn-warning btn-delete" name="{:url('@controller@/delete',array('id'=>$vo['cat_id']))}">删除</button>
                                        </td>
                                    </tr>
                                {/volist}
                            </tbody>
